...
use embedded_graphics::{
    fonts::Text, pixelcolor::BinaryColor, prelude::*, style::MonospacedTextStyle,
};
...
impl MonospacedFont for SevenSegmentFont {
...
fn main() -> Result<(), core::convert::Infallible> {
    ...
    Text::new("123", position)
        .into_styled(MonospacedTextStyle::new(SevenSegmentFont, BinaryColor::On))
        .draw(&mut display)?;

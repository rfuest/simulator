...
fn main() -> Result<(), core::convert::Infallible> {
    ...
    .into_styled(MonospacedTextStyle::new(Font6x12, BinaryColor::On))
    .draw(&mut display)?;

    // Show 8x16 Font
    Text::new(&format!("Font8x16 {}", test_text), Point::new(15, 45))
        .into_styled(MonospacedTextStyle::new(Font8x16, BinaryColor::On))
        .draw(&mut display)?;

    // Show 12x16 Font
    Text::new(&format!("Font12x16 {}", test_text), Point::new(15, 65))
        .into_styled(MonospacedTextStyle::new(Font12x16, BinaryColor::On))
        .draw(&mut display)?;
    ...
    .into_styled(MonospacedTextStyle::new(Font24x32, BinaryColor::On))
    .draw(&mut display)?;
